...
static void NET_SV_SendPacket(net_packet_t *packet) { QueuePush(&client_queue, NET_PacketDup(packet)); }
...
net_module_t net_loop_server_module = {
    NET_SV_InitClient, NET_SV_InitServer, NET_SV_SendPacket, NET_SV_RecvPacket, NET_SV_ResolveAddress,
};
