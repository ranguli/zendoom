...
// M_DrawMainMenu
//
void M_DrawMainMenu(void) { V_DrawPatchDirect(94, 2, W_CacheLumpName("M_DOOM", PU_CACHE)); }
...
void M_DrawEpisode(void) { V_DrawPatchDirect(54, 38, W_CacheLumpName("M_EPISOD", PU_CACHE)); }
