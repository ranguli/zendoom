...
void EV_VerticalDoor(line_t *line, mobj_t *thing) {
    ...
    if (line->sidenum[side ^ 1] == -1) {
        error("EV_VerticalDoor: DR special type on 1-sided linedef");
    }
        ...
        case 117:
            if (door->direction == -1)
                ...
                if (door->thinker.function.acp1 == (actionf_p1)T_VerticalDoor) {
                    ...
                    // The direction field in vldoor_t corresponds to the
                    // wait field in plat_t.  Let's set that to -1 instead.
                    ...
                    // Try closing it anyway. At least it will work on
                    // 32-bit machines.
