...
#define saveg_reathink_t saveg_read_actionf_t
...
static void saveg_reathinker_t(thinker_t *str) {
...
static void saveg_read_mobj_t(mobj_t *str) {
    ...
    // thinker_t thinker;
    saveg_reathinker_t(&str->thinker);
...
static void saveg_reaplayer_t(player_t *str) {
    int i;
...
void P_ArchiveThinkers(void) {
    ...
    for (th = thinkercap.next; th != &thinkercap; th = th->next) {
        ...
        // error ("P_ArchiveThinkers: Unknown thinker function");
    }
...
void P_UnArchiveThinkers(void) {
    ...
    while (1) {
        ...
        default:
            error("Unknown tclass %i in savegame", tclass);
        }
    }
}
