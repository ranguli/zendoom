...
cheatseq_t cheat_powerup[7] = {
    CHEAT("idbeholdv", 0), CHEAT("idbeholds", 0), CHEAT("idbeholdi", 0), CHEAT("idbeholdr", 0),
    CHEAT("idbeholda", 0), CHEAT("idbeholdl", 0), CHEAT("idbehold", 0),
};
    ...
    // if a user keypress...
        ...
        if (!netgame && gameskill != sk_nightmare) {
            ...
            // 'mypos' for player position
                ...
                M_snprintf(buf, sizeof(buf), "ang=0x%x;x,y=(0x%x,0x%x)", players[consoleplayer].mo->angle,
